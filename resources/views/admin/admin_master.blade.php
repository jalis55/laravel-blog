			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{url('/add_category')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> Add category</span></a></li>
						<li><a href="{{url('/manage_category')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Manage Category</span></a></li>
						<li><a href="{{url('/add_blog')}}"><i class="icon-eye-open"></i><span class="hidden-tablet">Add blog</span></a></li>
						<li><a href="{{url('/manage_blog')}}"><i class="icon-dashboard"></i><span class="hidden-tablet">Manage blog</span></a></li>
						<li>
